...
public class AsynchronousFileChannelWriteExample {
	public static void main(String[] args) throws Exception{
		...
		for(int i =0; i<10; i++){
			...
			Path path = Paths.get("C:/Windows/Temp/file"+i+".txt");
			Files.createDirectories(path.getParent()); //파일을 만들기? 
